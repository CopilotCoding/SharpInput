namespace InputLibrary
{
    ...
    public class Input
    {
        ...
        public int VK_IME_ON = 0x16;   // IME On
        public int VK_JUNJA = 0x17;   // IME Junja mode
        public int VK_FINAL = 0x18;   // IME final mode
        ...
        public int VK_SNAPSHOT = 0x2C;  // PRINT SCREEN key
        ...
        public int VK_3 = 0x33;     // 3 key
        public int VK_4 = 0x34;  // 4 key
        public int VK_5 = 0x35;  // 5 key
        public int VK_6 = 0x36;   // 6 key
        ...
        public int VK_D = 0x44;     // D key
        public int VK_E = 0x45;     // E key
        public int VK_F = 0x46;     // F key
        public int VK_G = 0x47;     // G key
        public int VK_H = 0x48;     // H key
        public int VK_I = 0x49;     // I key
        public int VK_J = 0x4A;     // J key
        public int VK_K = 0x4B;     // K key
        public int VK_L = 0x4C;     // L key
        public int VK_M = 0x4D;     // M key
        public int VK_N = 0x4E;     // N key
        public int VK_O = 0x4F;     // O key
        public int VK_P = 0x50;     // P key
        public int VK_Q = 0x51;     // Q key
        public int VK_R = 0x52;     // R key
        public int VK_S = 0x53;     // S key
        public int VK_T = 0x54;     // T key
        public int VK_U = 0x55;     // U key
        public int VK_V = 0x56;     // V key
        public int VK_W = 0x57;     // W key
        ...
        public int VK_NUMPAD3 = 0x63;   // Numeric keypad 3 key
        public int VK_NUMPAD4 = 0x64;   // Numeric keypad 4 key
        public int VK_NUMPAD5 = 0x65;   // Numeric keypad 5 key
        public int VK_NUMPAD6 = 0x66;   // Numeric keypad 6 key
        ...
        public int VK_F4 = 0x73;   // F4 key
        public int VK_F5 = 0x74;   // F5 key
        public int VK_F6 = 0x75;   // F6 key
        public int VK_F7 = 0x76;   // F7 key
        public int VK_F8 = 0x77;   // F8 key
        public int VK_F9 = 0x78;   // F9 key
        public int VK_F10 = 0x79;   // F10 key
        public int VK_F11 = 0x7A;   // F11 key
        public int VK_F12 = 0x7B;   // F12 key
        public int VK_F13 = 0x7C;   // F13 key
        public int VK_F14 = 0x7D;   // F14 key
        public int VK_F15 = 0x7E;   // F15 key
        public int VK_F16 = 0x7F;   // F16 key
        public int VK_F17 = 0x80;   // F17 key
        public int VK_F18 = 0x81;   // F18 key
        public int VK_F19 = 0x82;   // F19 key
        public int VK_F20 = 0x83;   // F20 key
        public int VK_F21 = 0x84;   // F21 key
        ...
        public int VK_RSHIFT = 0xA1;   // Right SHIFT key
        public int VK_LCONTROL = 0xA2;   // Left CONTROL key
        ...
        public int VK_BROWSER_STOP = 0xA9;   // Browser Stop key
        ...
        public int VK_OEM_MINUS = 0xBD;   // For any country/region, the '-' key
        public int VK_OEM_PERIOD = 0xBE;   // For any country/region, the '.' key
        public int VK_OEM_2 = 0xBF;   // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '/?' key
        public int VK_OEM_3 = 0xC0;   // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '`~' key
        public int VK_OEM_4 = 0xDB;   // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '[{' key
        public int VK_OEM_5 = 0xDC;   // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the '\|' key
        public int VK_OEM_6 = 0xDD;   // Used for miscellaneous characters; it can vary by keyboard. For the US standard keyboard, the ']}' key
        ...
        public int VK_CRSEL = 0xF7;   // CrSel key
        public int VK_EXSEL = 0xF8;   // ExSel key
        public int VK_EREOF = 0xF9;   // Erase EOF key
